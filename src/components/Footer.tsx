                ...
                <div className="flex items-center gap-3">
                  {socials.map((social) => (
                    <a
                      ...
                      className="p-2 rounded-full border border-neutral-200 dark:border-neutral-800 hover:border-foreground hover:bg-foreground hover:text-background text-neutral-600 dark:text-stone-400 transition-all focus:outline-hidden"
